  ...
  const handleSubmit = async () => {
    ...
    const orderData = {
      ...
      receipt_validation: receiptCheckerEnabled && receiptCheck.result ? {
        ...
        manipulationRisk: receiptCheck.result.manipulationRisk,
        manipulationFlags: receiptCheck.result.manipulationFlags,
        ocrConfidence: receiptCheck.result.ocrConfidence,
        receiptHash: receiptCheck.result.receiptHash,
        imageWidth: receiptCheck.result.imageWidth,
        imageHeight: receiptCheck.result.imageHeight,
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-xl shadow-slate-950/20 sm:p-6">
                  ...
                  <div className="flex flex-col items-center">
                    <img
                      ...
                      alt="Payment QR Code"
                      className="h-56 w-56 rounded-xl border border-slate-700 object-contain sm:h-64 sm:w-64"
                      onError={(e) => {
                ...
                {receiptPreview ? (
                  <div className="relative inline-block">
                    <img
                      src={receiptPreview}
                      alt="Receipt Preview"
                      className="max-h-64 max-w-full rounded-xl border border-slate-700"
                    />
                    <button
                      onClick={() => {
                        setReceiptPreview('');
